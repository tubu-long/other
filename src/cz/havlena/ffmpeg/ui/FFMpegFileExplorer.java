...
public class FFMpegFileExplorer extends ListActivity {
	...
	private void getDirectory(String dirPath) {
		try {
			...
			FFMpegMessageBox.showDialog(this, "Error", ex.getMessage());
		}
	}
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (file.isDirectory()) {
			if (file.canRead())
				...
				FFMpegMessageBox.showDialog(this, "Error", "[" + file.getName() + "] folder can't be read!");
			}
		} else {
			if(!checkExtension(file)) {
				...
				FFMpegMessageBox.showDialog(this, "Error", "File must have this extensions: " + strBuilder.toString());
				return;
			}
